			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul
						...
						<li class="nav-item" role="presentation">
							<button class="nav-link rounded-5 custom-tab" id="file-tab2"
								...
								aria-selected="false" onclick="filePage()">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
				...
				<div class="user-container ml-auto divL">
					<div class="btn-group">
						...
						<c:out value="${sessionScope.USER_INFO.username}" default=" 用 户 " />
						</button>
...
function fadeIn(element) {
	...
	function filePage() {
	    ...
	    // 检查username是否存在
	    if (!username) {
	        window.location.href = "http://localhost:8080/pdh-java-web/error.jsp";
	        return;
	    }
	
	    var folderPath = '<%= folderPath %>';
	    var encodedFolderPath = encodeURIComponent(folderPath);
	    var redirectUrl = "http://localhost:8080/pdh-java-web/filelist.jsp?path=" + encodedFolderPath;
	...
	function homePage() {
	  ...
	  xhttp.open("GET", "homepage.jsp", true);
	  xhttp.send();
	}
